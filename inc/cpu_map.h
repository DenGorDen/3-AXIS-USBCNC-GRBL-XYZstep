...
/* virtuaL  PIN -> DIRECTION_BIT */
#define X_STEP_BIT      0
#define Y_STEP_BIT      1
#define Z_STEP_BIT      2
#define STEP_MASK       ((1<<X_STEP_BIT)|(1<<Y_STEP_BIT)|(1<<Z_STEP_BIT))// маска, за якою система знає кількість осей руху та видає сигнали step   //  limits.c  stepper.c


#define X_DIRECTION_BIT   4
#define Y_DIRECTION_BIT   5
#define Z_DIRECTION_BIT   6
#define DIRECTION_MASK    ((1<<X_DIRECTION_BIT)|(1<<Y_DIRECTION_BIT)|(1<<Z_DIRECTION_BIT))// маска, за якою система знає кількість осей руху та видає сигнали  direction //only stepper.c

// Define XYZ-AXIS step output pins. NOTE: All direction pins must be on the same port.
#define X_STEP_PORT          GPIOB
#define RCC_X_STEP_PORT      RCC_APB2Periph_GPIOB
#define X1_STEP_BIT             9
#define X2_STEP_BIT             10
#define X3_STEP_BIT             11
#define X4_STEP_BIT             12
//#define X_MOTOR_MASK       ((1<<X1_BIT)|(1<<X2_BIT))
#define X_STEPMOTOR__MASK    ((1<<X1_STEP_BIT)|(1<<X2_STEP_BIT)|(1<<X3_STEP_BIT)|(1<<X4_STEP_BIT)/**/) // All X-AXIS step bits

#define Y_STEP_PORT         GPIOA
#define RCC_Y_STEP_PORT      RCC_APB2Periph_GPIOA
#define Y1_STEP_BIT             0
#define Y2_STEP_BIT             1
#define Y3_STEP_BIT             2
#define Y4_STEP_BIT             3
//#define Y_MOTOR_MASK       ((1<<Y1_BIT)|(1<<Y2_BIT))
#define Y_STEPMOTOR__MASK    ((1<<Y1_STEP_BIT)|(1<<Y2_STEP_BIT)|(1<<Y3_STEP_BIT)|(1<<Y4_STEP_BIT)) // All Y-AXIS step bits

#define Z_STEP_PORT         GPIOA
#define RCC_Z_STEP_PORT     RCC_APB2Periph_GPIOA

#define Z1_STEP_BIT   4
#define Z2_STEP_BIT   5
#define Z3_STEP_BIT   6
#define Z4_STEP_BIT   7
#define Z_STEPMOTOR__MASK    ((1<<Z1_STEP_BIT)|(1<<Z2_STEP_BIT)|(1<<Z3_STEP_BIT)|(1<<Z4_STEP_BIT)) // All Z-AXIS step bits
